      ...
      <div class="container "><br>
         <div class="container">
            ...
            <div class=" col-lg-12 text-center">
               <h3> <a href="#" class="text-uppercase text-warning"> <?php echo $_SESSION['']; ?>,</a> Welcome to ThapaTechnical Quiz </h3>
            </div>
            <br>
            <div class="col-lg-8 d-block m-auto bg-light quizsetting ">
               <div class="card">
                  <p class="card-header text-center" > <?php echo $_SESSION['']; ?>, you have to select only one out of 4. Best of Luck <i class="fas fa-thumbs-up"></i>	 </p>
               </div>
               <br>
               <form action="checked.php" method="post">
                  <?php
                     ...
                     $sql1 = "SELECT * FROM `quesion` WHERE `qid` = $i ";
                  ...
                  <div class="card">
                     <br>
                     <p class="card-header">  <?php echo $i ." : ". $row1['quesion']; ?> </p>
                    
                     <?php
                        $sql = "SELECT op1,op2,op3,op4 FROM quesion WHERE `qid` = $i limit $page1, 1";
                     ...
                     <div class="card-block">
                        <input type="radio" name="quizcheck[<?php echo $qid; ?>]" id="<?php echo $qid; ?>" value="<?php echo $row['ans']; ?>" > <?php echo $row['ans']; ?> 
                        <br>
                     </div>
                     <?php
