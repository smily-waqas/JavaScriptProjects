...
<body>
	...
	<br><h1 class="text-center text-primary">WRS Online Quiz</h1><br>
		<h2 class="text-center text-success" > Welcome <?php echo $_SESSION['user_name']; ?> </h2> <br>
		<div class="col-md-2"></div>
		<div class="col-xl-8 col-lg-8 col-md-8 col-sm-8 m-auto d-block">
		<div class="card">

			<h3 class="text-center card-header">  Welcome <?php echo $_SESSION['user_name']; ?>, You Have select only one out of 4 Best of Luck :) </h3>
